...
<html>
<head>
    <title>Магазин компьютерной техники (ADMIN)</title>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top">
    <div class="container-fluid">
        <a class="navbar-brand" href="<c:url value="/main"/>">Магазин компьютерной техники (ADMIN)</a>
                ...
                <div class="card shadow-2-strong" style="border-radius: 1rem;">
                    <div class="card-body p-5 text-center">
                        <form id="add-component" action="<c:url value="/admin/case/${ccase.id}/edit"/>" method="post"
                            ...
                            <h3 class="mb-5">Update computer case</h3>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" name="maxGraphicsCardWidth"
                                           id="inputCrystalName5"
                                           placeholder="graphics card max width" step="any"
                                           value="${ccase.maxGraphicsCardWidth}"
                                           required>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" name="maxPowerUnitWidth"
                                           id="inputCrystalName6"
                                           placeholder="power unit max width" step="any"
                                           value="${ccase.maxPowerUnitWidth}"
                                           required>
                                </div>
                            </div>
                            <div class="mb-3 row">
