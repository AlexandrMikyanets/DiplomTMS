...
<div class="container align-items-center mt-5">
    <table class="table table-bordered table-striped table-hover align-middle">
        <caption class="caption-top text-center mt-5"><h2>Информация о пользователе</h2></caption>
        <tbody>
        <tr>
                        ...
                        <form action="/user/${user.id}/computer/${computer.id}/delete" method="post"
                            ...
                            <sec:authorize access="hasAuthority('USER')">
                                ...
                                <c:if test="${computer.user.id eq user_id}">
                                    <button class="btn btn-primary" type="submit" style="float: right;">Удалить</button>
                                </c:if>
                            </sec:authorize>
                        </form>
                    </div>
