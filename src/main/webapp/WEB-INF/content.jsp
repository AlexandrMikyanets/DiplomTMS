...
<div class="container align-items-center mt-5" style="min-height: 77.6vh;">
    <div class="row pt-3">
        <h3 class="col">
            Страница администратора(Добавление, удаление, редактирование товара)
        </h3>
    </div>
    <form action="<c:url value="/admin/content"/>" method="get">
        <div class="input-group w-100 p-0 m-0">
            ...
            <button class="btn btn-outline-secondary" type="submit">Выберите тип</button>
            <button class="btn btn-success" formaction="/admin/content/new" type="submit">Новый товар</button>
        </div>
    </form>
